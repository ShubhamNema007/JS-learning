...
// let r = num.pop() // pop Remove last element form arrays. // pop returns the popped element 
// console.log(num, r)
...
// let r = num.unshift(78) // add element of the beginning of arrays. and return new arrays.
console.log(r, num)
console.log(r)
...
// Splice and Slice -- Splice can be used to add new itemes to an arrays -- slice is out of piece an arrays and it creates new arrays.
// let num = [551, 22, 3, 14, 5, 6, 7, 8, 229]
